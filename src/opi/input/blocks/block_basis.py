...
class BlockBasis(Block):
    ...
    basis: SimpleKeyword | None = None # define orbital basis set
    auxj: SimpleKeyword | None = None  # define the J auxiliary basis set
    gtoaux: SimpleKeyword | None = None
    auxbasis: SimpleKeyword | None = None # define the auxiliray basis set
    aux: SimpleKeyword | None = None    # define the auxiliary basis set
    auxc: SimpleKeyword | None = None   # define the correlation auxiliary basis set
    auxx: SimpleKeyword | None = None   # **
    ecp: SimpleKeyword | None = None    # assign respective ECP to all elements for which it is available
    auxjk: SimpleKeyword | None = None  # define JK auxiliary basis set
    cabs: SimpleKeyword | None = None   # define complementaru auxiliary basis set for F12 calculations
    gtocabs: SimpleKeyword | None = None #**
    cabsbasis: SimpleKeyword | None = None
    gtoname: InputFilePath | None = None      # read orbital basis from file
    gtoauxname: InputFilePath | None = None   # read Aux from file
    gtoauxjname: InputFilePath | None = None  # read AuxJ from file
    gtoauxcname: InputFilePath | None = None  # read AuxC from file
    gtoauxxname: InputFilePath | None = None  # **
    gtoauxjkname: InputFilePath | None = None # read AuxJK from file
    gtocabsname: InputFilePath | None = None  # read CABS from file
    newgto: NewBasis | None = None      # define new Basis for element via built-in name and/or custom shells
    addgto: NewBasis | None = None      # add GTO shells to basis for element
    newauxgto: NewBasis | None = None   # define new aux set for element via built-on name and/or custom shell
    addauxgto: NewBasis | None = None   # add GTO shells to aux for element
    newauxjgto: NewBasis | None = None  # define new AuxJ set for element via built-in name and/or custom shells
    addauxjgto: NewBasis | None = None  # add GTO shells to AuxJ for element
    newauxcgto: NewBasis | None = None  # define new AuxC set for element
    addauxcgto: NewBasis | None = None  # add GTO shells to AuxC for element
    newauxxgto: NewBasis | None = None
    addauxxgto: NewBasis | None = None
    newauxjkgto: NewBasis | None = None # define new AuxJK set for element via built-in name and/or custom shells
    addauxjkgto: NewBasis | None = None # add GTO shells to AuxJK for element
    fragbasis: FragBasis | None = None  # define Basis for fragment
    fragaux: FragAux | None = None      # define Aux set for fragment
    fragauxj: FragAuxJ | None = None    # define AuxJ for fragment
    fragauxc: FragAuxC | None = None    # define AuxC for fragment
    fragauxjk: FragAuxJK | None = None  # define AuxJK for fragment
    fragcabs: FragCabs | None = None    # define CABS for fragment
    fragecp: FragEcp | None = None      # define ECP for fragment
    readfragbasis: InputFilePath | None = None  # read Basis for fragment from file
    readfragaux: InputFilePath | None = None    # read Aux set for fragment from file
    readfragauxj: InputFilePath | None = None   # read AuxJ for fragment from file
    readfragauxc: InputFilePath | None = None   # read AuxC for fragment from file
    readfragauxjk: InputFilePath | None = None  # read AuxJK for fragment from file
    readfragcabs: InputFilePath | None = None   # read CABS for fragment from file
    readfragecp: InputFilePath | None = None    # read ECP for fragment from file
    newecp: NewBasis | None = None      # define new built-in ECP for element
    delecp: Element | None = None       # remove the ECP for the element
